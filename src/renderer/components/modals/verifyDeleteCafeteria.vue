<template>
  <div class="modal fade" id="deleteVerifyCafeteria" tabindex="-1" role="dialog" aria-labelledby="deleteVerifyCafeteria" aria-hidden="true">
...
export default {
  ...
  methods:{
    async removeData(){
      ...
      Loader.hide();
      $('#deleteVerifyCafeteria').modal('hide');
      // Validando respuesta
      if(request.success){
